		...
		<div class="card-body">
			<form action="" id="manage_cliente">
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					...
					<button class="btn btn-secondary" type="button" onclick="location.href = '<?php echo SERVERURL ?>clients/list/'">Cancelar</button>
				</div>
			</form>
		</div>
	</div>
...
<script>
	$('#manage_cliente').submit(function(e) {
		e.preventDefault()
		...
		$.ajax({
			...
			success: function(resp) {
				if (resp == 1) {
					...
					setTimeout(function() {
						location.replace('<?php echo SERVERURL ?>clients/list/')
					}, 750)
				}
			}
		})
